...
import { Database, Shield, AlertTriangle, RefreshCw, Loader2, CheckCircle2, HardDrive } from 'lucide-react';
...
export default function DSPMPage() {
  ...
  React.useEffect(() => {
    document.title = 'Data (DSPM) - CloudVisor';
  }, []);
  ...
  return (
    <ProtectedRoute>
      <AppLayout breadcrumbs={[{ text: 'Home', href: '/console' }, { text: 'Data (DSPM)' }]}>
        {accountIds.length === 0 ? (
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-h1" style={{ color: 'var(--text-primary)' }}>DSPM — Data Security Posture</h1>
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Data classification, access mapping, and exposure risk</p>
          </div>
        ...
        <ModuleTabBar module="dspm" activeTab={activeTab} onTabChange={setActiveTab} />
