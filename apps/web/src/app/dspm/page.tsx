...
export default function DSPMPage() {
  ...
  return (
    <ProtectedRoute>
      <AppLayout
        breadcrumbs={[{ text: 'Home', href: '/console' }, { text: 'DSPM' }]}
      ...
      >
        {accountIds.length === 0 ? (
          ...
          <>
            ...
            {activeTab === 'overview' && (
              <div className="mb-4">
                <h1 className="text-h1" style={{ color: 'var(--text-primary)' }}>Data Security Posture Management</h1>
                <p className="mt-0.5 text-sm" style={{ color: 'var(--text-secondary)' }}>
                  Data classification, access mapping, and exposure risk
                </p>
              </div>
            )}
