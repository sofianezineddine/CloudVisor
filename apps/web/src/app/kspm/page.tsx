...
import { Network, Shield, AlertTriangle, RefreshCw, Loader2, CheckCircle2 } from 'lucide-react';
...
export default function KSPMPage() {
  ...
  React.useEffect(() => {
    document.title = 'Kubernetes (KSPM) - CloudVisor';
  }, []);
  ...
  return (
    <ProtectedRoute>
      <AppLayout breadcrumbs={[{ text: 'Home', href: '/console' }, { text: 'Kubernetes (KSPM)' }]}>
        {accountIds.length === 0 ? (
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-h1" style={{ color: 'var(--text-primary)' }}>KSPM — Kubernetes Security</h1>
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Cluster configuration and runtime security posture</p>
          </div>
        ...
        <ModuleTabBar module="kspm" activeTab={activeTab} onTabChange={setActiveTab} />
